# ZLS 0.14.0 dependencies with corrected hashes.
#
# The upstream deps.nix (in the zigtools/zls 0.14.0 tag) contains a stale
# sha256 for the lsp-codegen tarball. GitHub regenerated the archive at the
# same URL, changing its hash. This file is a corrected copy.
#
  ...
  linkFarm name [
    ...
    }
    {
      ...
      path = fetchZigArtifact {
        ...
        # Corrected hash: GitHub regenerated this tarball, changing its hash.
        # Old (stale) hash: sha256-7rnQLdnlt/riREREl31XhqQZn4FJHGAcQaz/zcslHNs=
        hash = "sha256-IqoRpOKCtHJNRbqycAFPcHMKyRVQioQkxIKf6Sfq6Ls=";
      };
    }
  ]
